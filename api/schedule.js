...
function buildSchedule(projectName, durationDays, startDate, phases) {
  ...
  let table = '<table style="width:100%;border-collapse:collapse;color:#111;"><tr style="background:#f0f0f0;"><th style="padding:10px;text-align:left;color:#111;">Phase</th><th style="color:#111;">Start</th><th style="color:#111;">End</th><th style="color:#111;">Days</th></tr>';
  rows.forEach((r) => {
